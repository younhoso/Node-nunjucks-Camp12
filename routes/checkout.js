...
const iamporter = new Iamporter({
    apiKey: '9933778544022539',
    // apiKey: 'process.env.apiKey',
    secret: 'U6lM5Y32SqnDdh9DH9RYJcTEJQbw0jAUqWGvVKyNaVrncA1UKSTu4M8NCkkDEVx4ReANY8A941xhCycn'
});
...
router.get('/shipping/:invc_no', (req,res)=>{
    ...
    request(url, (error, response, body) => {  
        ...
        res.render( 'checkout/shipping' , { result }); //최종값 전달
    });
});
